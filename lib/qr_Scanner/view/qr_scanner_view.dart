                    ...
                    if (qrList[0].toString().contains(API.getPartyBookingHistory)) {
                      if (list[2].toString() == dashboardController.organisationID.value) {
                        ...
                        Fluttertoast.showToast(
                          msg: ' This qr is not valid for this pub ',
                        );
                        Get.back();
                      }
                    } else {
                      Fluttertoast.showToast(
                        msg: ' Invalid QR, please scan qr for party people ',
                      );
                      Get.back();
                    }
          ...
          Expanded(
            ...
            child: Column(
              children: [
                ...
                Text('Powered by PartyPeople', style: TextStyle(fontSize: 18, color: Colors.white70)),
              ],
            ),
          ))
        ]),
